...
gui.add(uniforms.uPositionFrequency, 'value', 0, 2, 0.01).name('uPositionFrequency')
...
gui.add(uniforms.uWarpPositionFrequency, 'value', 0, 2, 0.01).name('uWarpPositionFrequency')
gui.add(uniforms.uWarpTimeFrequency, 'value', 0, 2, 0.01).name('uWarpTimeFrequency')
